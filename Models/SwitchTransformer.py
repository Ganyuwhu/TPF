...
"""
    Switch Transformer TensorFlow: https://github.com/tensorflow/mesh/blob/master/mesh_tensorflow/transformer/moe.py
    PyTorch: https://github.com/kyegomez/SwitchTransformers/tree/main
"""
...
class Model(nn.Module):
    def __init__(self, configs):
        super().__init__()
        self.model = SwitchTransformer(
            seq_len=configs.seq_len,
            pred_len=configs.pred_len,
            num_tokens=configs.n_vars,
            dim=configs.dim,
            heads=configs.heads,
...
if __name__ == "__main__":
    ...
    y = model.pack_forward(input_datas)
    print(y.shape)
