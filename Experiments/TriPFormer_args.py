...
def get_site_args():
    ...
    parser.add_argument("--pre_dropout", type=float, default=0.1)
    parser.add_argument("--dims", type=tuple, default=(1, 2))
    parser.add_argument("--n_layers", type=int, default=3)
    parser.add_argument("--n_pollutants", type=int, default=3)
    parser.add_argument("--n_heads", type=int, default=4)
    parser.add_argument("--attn_type", type=str, default="DM")
    parser.add_argument("--mask_flag", type=bool, default=False)
    parser.add_argument("--scale", type=float, default=None)
    parser.add_argument("--tau", type=float, default=None)
    parser.add_argument("-delta", type=float, default=0.)
    parser.add_argument("--attention_dropout", type=float, default=0.1)
    parser.add_argument("--output_attention", type=bool, default=False)
    parser.add_argument("--init_model", type=str, default="kaiming")
